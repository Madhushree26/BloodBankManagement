...
.bg-text {
	...
	color: white;
	font-weight: bold;
	border: 3px solid #f1f1f1; /*#f1f1f1*/
	position: absolute;
	top: 100%;
	left: 50%;
	...
	<div class="bg-text">
		...
		<form class="row g-3" action="submitForm"
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="name" path="name" required>
			</div>
			<div class="col-md-6">
				<label for="mail" class="form-label">Email</label> <span>*</span>
				 <input type="email" class="form-control" name="mail" path="mail" placeholder="abc@example.com" required>
			</div>
